# src/evaluation/calculate_metrics_deepseek.py
...
def generate_answer_deepseek(
    ...
    # DeepSeek-R1 uses thinking tags — need to strip them
...
Answer in 1-3 sentences:"""
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            # DeepSeek-R1 outputs <think>...</think>
...
def evaluate_single(
    ...
    answer  = generate_answer_deepseek(question, context)
...
def print_report(summary: dict):
    ...
    path = f"results/eval_DEEPSEEK_{ts}.json"
